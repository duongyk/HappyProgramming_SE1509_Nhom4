 ...
 * @author solov
 */
@WebServlet(name = "SortMenteeByNameController", urlPatterns = {"/sortMenteeByName"})
public class SortMenteeByNameController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<User> menteeList = userDAO.getSortedUserByRolePaging(index, 1);
            ...
            sendDispatcher(request, response, "sortedmenteeManagement.jsp");
        } catch (Exception e) {
    ...
    public void sendDispatcher(HttpServletRequest request, HttpServletResponse response, String path) {
        try {
            ...
            Logger.getLogger(SortMenteeByNameController.class.getName()).log(Level.SEVERE, null, ex);
