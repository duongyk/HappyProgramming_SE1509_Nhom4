        ...
        <div class="u-form u-form-1">
          <form id="thisform" action="CVControllerMap?service=submitFormUpdate" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-9 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 0px;" redirect="true">
            ...
            <div class="u-form-group u-form-group-5">
              ...
              <input type="text" placeholder="Mail" id="text-b9a0" name="mail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Email pattern: abcxyz@abcxyz.domain" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" value="<c:out value="${mentorprofile.getMail()}"></c:out>" required="required">
            </div>
            <div class="u-form-group u-form-group-6">
                <label for="text-0855" class="u-form-control-hidden u-label"></label>
                <input type="tel" placeholder="Phone" pattern="[0-9]{9,11}" title="phone with 9 to 11 number" id="text-0855" name="phone" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required" value="<c:out value="${mentorprofile.getPhone()}"></c:out>">
            </div>
            ...
            <div class="u-form-checkbox u-form-group u-form-partition-factor-2 u-form-group-<c:out value="${count}"></c:out>">
                ...
                <c:choose>
                    <c:when test="${mentorskill.contains(String.valueOf(skill.getId()))}">
                <input type="checkbox" name="skills" value="<c:out value="${skill.getId()}"></c:out>" checked>
            ...
            <div class="u-align-center u-form-group u-form-submit">
              <a href="#" class="u-border-none u-btn u-btn-submit u-button-style u-custom-color-3 u-text-body-alt-color u-btn-1">Update CV</a>
