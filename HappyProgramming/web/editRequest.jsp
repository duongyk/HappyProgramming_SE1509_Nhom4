                                    ...
                                    <c:when test="${req.getStatus()==1}">
                                        <form action="RequestControllerMap?service=editRequest" method="POST">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="value">
                                                    <div class="input-group">
                                                        <input class="input--style-5" type="date" value="<c:out value="${req.deadlineDate}"></c:out>" name="deadlineDate" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="value">
                                                    <div class="input-group">
                                                        <input class="input--style-5" type="number" min="1" max="12" value="<c:out value="${req.deadlineHour}"></c:out>" placeholder="The time you want to request" name="deadlineHour" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                                    ...
                                                                    <c:forEach items="${sListAll}" var="skill">
                                                                        ...
                                                                        <c:choose>
                                                                            <c:when test="${sessionScope.continueBox}">
                                                                                <li>
                                                                                    <input class="form-check-input" type="checkbox" id="${skill.getId()}" name="skill" value="${skill.getId()}" checked>
                                                                                    <label class="form-check-label" style="word-wrap:break-word" for="${skill.getId()}">${skill.getName()}</label>
                                                                                </li>
                                                                            </c:when>
                                                                            <c:otherwise>
                                                                                <li>
                                                                                    <input class="form-check-input" type="checkbox" id="${skill.getId()}" name="skill" value="${skill.getId()}">
                                                                                    <label class="form-check-label" style="word-wrap:break-word" for="${skill.getId()}">${skill.getName()}</label>
                                                                                </li>
                                                                            </c:otherwise>
                                                                        </c:choose>
