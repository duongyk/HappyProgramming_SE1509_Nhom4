                ...
                <div class="u-form u-form-1">
                    <form action="SkillControllerMap" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-26 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 50px;" redirect="true">
                        ...
                        <div class="u-form-group u-form-group-1">
                            <input type="text" placeholder="Skill name" id="text-b048" name="sName" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
                        </div>
                        <div class="u-form-group u-form-message u-form-group-2">
                            <textarea id="text-3911" name="sDetail" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" placeholder="Detail" required="required"></textarea>
                        </div>
                        <div class="u-form-group u-form-message u-form-group-2">
                            <textarea name="sImage" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" placeholder="Image" required="required"></textarea>
                        </div>
                        ${mess}
