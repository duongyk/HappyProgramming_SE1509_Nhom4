                            ...
                            <c:forEach items="${listRequest}" var="request">
                                <div class="u-container-style u-list-item u-repeater-item u-video-cover u-white">
                                    <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1">
                                        ...
                                        <h3 class="u-text u-text-default u-text-2">Status: Pending</h3>
                                        </c:if>
                                        <c:if test="${request.status==2}">
                                        <h3 class="u-text u-text-default u-text-2">Status: In process</h3>
                                        </c:if>
                                        <c:if test="${request.status==3}">
                                        <h3 class="u-text u-text-default u-text-2">Status: Done</h3>
                                        </c:if>
                                        <c:if test="${request.status==4}">
                                        <h3 class="u-text u-text-default u-text-2">Status: Canceled</h3>
                                        </c:if>
                                        <div class="u-border-4 u-border-custom-color-3 u-expanded-width u-line u-line-horizontal u-line-1"></div>
                                        <p class="u-align-left u-text u-text-3"><c:out value="${request.title}"></c:out></p>
                                        <a href="RequestControllerMap?service=viewRequest&rId=${request.id}" class="u-border-none u-btn u-button-style u-custom-color-3 u-btn-3">View Request</a>
                                    </div>
                                </div>
                            </c:forEach>
                        </div>
    ...
    <section class="u-black u-clearfix u-container-style u-dialog-block u-opacity u-opacity-70 u-valign-middle u-section-4" id="sec-1114">
        <div class="u-align-center u-container-style u-dialog u-white u-dialog-1">
            <div class="u-container-layout u-container-layout-1">
                <h6 class="u-text u-text-font u-text-1">Total of request:aa<br>Total hours:aa<br>Total mentors:aa&nbsp;
                </h6>
